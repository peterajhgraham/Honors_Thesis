"""
Experiment: ROC Analysis under Pink (1/f) Noise

Repeats the white-noise ROC experiment using pink noise (1/f spectrum),
which is a more realistic model of background EEG activity. Produces
the same suite of diagnostic plots for comparison.
"""
...
from src.eeg.analysis.noise import generate_pink_noise
...
# --- Visualise sample signals with pink noise ---
visualize_sample_signals(
    FREQUENCIES, AMPLITUDES, WAVE_NAMES, [0.5, 5.0, 50.0, 500.0],
    generate_wavelet_signal, get_ngram_sequence_simple,
    DURATION, SAMPLING_RATE,
    noise_fn=generate_pink_noise,
    save_path="eeg_signal_samples_pink_noise.png",
)
...
results_df = run_eeg_wavelet_experiments(
    ...
    n_repeats=3,
    generate_noise_fn=generate_pink_noise,
)

# --- Plots ---
plot_roc_curves(
    results_df, WAVE_NAMES, [0.1, 1.0, 10.0, 100.0],
    save_path="eeg_wavelet_roc_curves_pink_noise.png",
)
plot_auc_vs_noise(
    results_df, WAVE_NAMES, NOISE_LEVELS, log_scale=True,
    save_path="eeg_wavelet_auc_vs_noise_pink_log.png",
)
plot_precision_vs_noise(
    results_df, WAVE_NAMES, NOISE_LEVELS, log_scale=True,
    save_path="eeg_wavelet_precision_vs_noise_pink_log.png",
)
...
print("\nPerformance Summary (Pink Noise):")
